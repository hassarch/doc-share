...
/**
 * The only door into physical file storage (FR-5.3): callers pass an
 * opaque object key and get bytes in/out — they never see bucket names,
 * node selection, or any MinIO-specific type. When multi-node storage and
 * chunking (PRD Phase 2/4) arrive, this interface's shape doesn't need to
